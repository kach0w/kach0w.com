    ...
    <div className='w-[100vw] text-[#222] h-[100vh] bg-[#f3f3f3] text-center font-serif'>
      ...
      <div className='mx-auto w-[25rem] sm:w-[70rem] grid grid-cols-1 sm:grid-cols-3 mt-[5rem]'>
        <a href="/blog/summerupdate">
          <div className='w-[20rem] h-[10rem] group rounded-md shadow-[0_1px_4px_rgba(0,0,0,0.16)] mx-auto p-3 mb-[3vh] text-left'>
        ...
        <a href="/blog/wikipedia">
          <div className='w-[20rem]  h-[10rem]  group rounded-md shadow-[0_1px_4px_rgba(0,0,0,0.16)] mx-auto p-3 mb-[3vh] text-left'>
            <p className='font-bold group-hover:underline text-slate-900 not-italic'>Wikipedia</p>
        ...
        <a href="/blog/express">
          <div className='w-[20rem] group rounded-md shadow-[0_1px_4px_rgba(0,0,0,0.16)] mx-auto p-3 mb-[3vh] text-left'>
            <p className='font-bold group-hover:underline text-slate-900 not-italic'>Express JS</p>
        ...
        <a href="/blog/openai">
          <div className='w-[20rem] group rounded-md shadow-[0_1px_4px_rgba(0,0,0,0.16)] mx-auto p-3 mb-[3vh] text-left'>
            <p className='font-bold group-hover:underline text-slate-900 not-italic'>OpenAI</p>
        ...
        <a href="/blog/statistics">
          <div className='w-[20rem] group rounded-md shadow-[0_1px_4px_rgba(0,0,0,0.16)] mx-auto p-3 mb-[3vh] text-left'>
            <p className='font-bold group-hover:underline text-slate-900 not-italic'>Statistics with ChartJS</p>
        ...
        <a href="/blog/pokedex">
          <div className='w-[20rem] group rounded-md shadow-[0_1px_4px_rgba(0,0,0,0.16)] mx-auto p-3 mb-[3vh] text-left'>
            <p className='font-bold group-hover:underline text-slate-900 not-italic '>Pokédex</p>
        ...
        <a href="/blog/javascript">
          <div className='w-[20rem] group rounded-md shadow-[0_1px_4px_rgba(0,0,0,0.16)] mx-auto p-3 mb-[3vh] text-left'>
            <p className='font-bold group-hover:underline text-slate-900 not-italic'>Javascript</p>
